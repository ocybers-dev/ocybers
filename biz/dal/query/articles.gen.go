...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.Views = field.NewInt64(tableName, "views")
	_article.IsDeleted = field.NewInt32(tableName, "is_deleted")
...
type article struct {
	...
	Status    field.Int32 // 0=draft, 1=published, 2=archived
	Slug      field.String
	Views     field.Int64
	IsDeleted field.Int32 // 0=active, 1=deleted
...
func (a *article) updateTableName(table string) *article {
	...
	a.Views = field.NewInt64(table, "views")
